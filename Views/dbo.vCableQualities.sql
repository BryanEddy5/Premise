...
SELECT        dbo.tblCableConstructionReferences.Base, dbo.tblCableConstructionReferences.DesignCode, dbo.tblCableConstructionReferences.DesignExtension, 
                         ...
                         dbo.tblCableTightBufferReference.TightBuffered, Cable.[Jacket Color] AS CableColor, Cable.[Fiber Oracle item] AS Fiber1, Cable.FiberType2 AS Fiber2, 
                         Cable.FiberType3 AS Fiber3, Cable.[Item No] AS ItemNo, Cable.[New Oracle Part #] AS ItemNumber, Cable.Customer, Cable.[Customer Part#] AS PID, 
                         Cable.CustomerRev, Cable.Active AS CableItemActive, Cable.Reason, Cable.RibbonHighCure, dbo.tblCableTBType.OracleTBDesc, 
                         dbo.tblCableTBType.TBLetterIndicator, dbo.tblCableTightBufferReference.ComponentSelection, TBTypeID, Cable.[Print Line 2]
FROM            dbo.tblCableConstructionReferences INNER JOIN
                         ...
                         dbo.[Basic Product Construction] AS Cable ON Cable.Base = dbo.tblCableConstructionReferences.Base LEFT JOIN
                         dbo.tblCableTightBufferReference ON dbo.tblCableTightBufferReference.TBType = dbo.tblCableConstructionReferences.TBType LEFT JOIN
                         dbo.tblCableTBType ON dbo.tblCableTightBufferReference.TBTypeID = dbo.tblCableTBType.TBIndicatorID AND 
                         dbo.tblCableTBType.TBLetter = SUBSTRING(Cable.[Item No], 12, 1)
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         SortOrder = 1410
         GroupBy = 1350
         Filter ', 'SCHEMA', N'dbo', 'VIEW', N'vCableQualities', NULL, NULL
GO
