...
Begin Form
    ...
    Filter ="ConstructionID = 733"
    OrderBy ="[tblBurnListingRating].[ConstructionID], [tblBurnListingRating].[Rating]"
    RecSrcDt = Begin
        0xa299ec9d6f22e540
    End
    RecordSource ="tblBurnListingRating"
    Caption ="Item Search"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ColumnOrder =0
                    TabIndex =3
                    Name ="BurnListingConstructionID"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DISTINCTROW tblBurnListingRatingReference.Rating FROM tblBurnListingRatin"
                        "gReference ORDER BY tblBurnListingRatingReference.Rating;"
...
ml_ID = Nz(Me.BurnListingConstructionID, Me.ConstructionID)
ID = ml_ID
End Property
