Operation =1
Option =0
Where ="(((qryPremiseItemDetails_Union.OracleItemNumber)=[Forms]![frmMainMenu]![ItemNumb"
    "erSelect]))"
Begin InputTables
...
dbBinary "GUID" = Begin
    0x078d4000579bfc45b591a1b394009c6a
End
Begin
    Begin
        ...
        dbBinary "GUID" = Begin
            0x8cef7b6134106f40ab3ec290fd2d8a92
        End
    End
    Begin
        ...
        dbLong "AggregateType" ="-1"
        dbBinary "GUID" = Begin
            0x59bdd1639a549643926a79ce7e823cc2
        End
    End
    Begin
